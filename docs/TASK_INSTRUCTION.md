...
- [x] Implement NextAuth (RBAC: Superadmin, Admin, Operator).
- [x] Setup `next-intl` for ID/EN localization.

## Phase 2: Core UI & Layout

- [x] Build global `DashboardLayout` component (Sidebar, Top Navigation).
- [x] Implement Dark Mode toggle (`next-themes`).
- [x] Implement Language Switcher in the header.
- [x] Setup base `Dashboard` page with mock metric cards.
